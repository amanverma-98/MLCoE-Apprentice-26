...
##   Technical Interests
* **Web Development:** Hands-on experience with **HTML** and **CSS** to design structured, visually appealing web pages.
* **Databases:** Working knowledge of **SQL** for managing and querying structured data.
* **Exploring New Technologies:** Eager to dive deeper into full-stack development, software engineering principles, and emerging tech stack tools.
